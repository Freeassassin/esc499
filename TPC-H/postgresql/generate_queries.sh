...
for i in $(seq 1 22); do
  ...
  # qgen appends rowcount clauses as a new statement; convert to valid PostgreSQL LIMIT syntax.
...
echo "Generated all 22 PostgreSQL-compatible query files in ${OUT_DIR}."
