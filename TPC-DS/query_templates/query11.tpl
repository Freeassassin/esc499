...
-- 
 ...
 where t_s_secyear.customer_id = t_s_firstyear.customer_id
         ...
         and case when t_w_firstyear.year_total > 0 then t_w_secyear.year_total / NULLIF(t_w_firstyear.year_total, 0) else 0.0 end
             > case when t_s_firstyear.year_total > 0 then t_s_secyear.year_total / NULLIF(t_s_firstyear.year_total, 0) else 0.0 end
