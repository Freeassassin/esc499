...
CREATE TEMP TABLE tmp_i_6442 AS SELECT * FROM ( select  c_last_name
       ,c_first_name
       ,ca_city
       ,bought_city
       ,ss_ticket_number
 ...
 from (select ss_ticket_number
             ,ss_customer_sk
             ,ca_city bought_city
             ,COUNT(CAST((ss_ext_sales_price) AS VARCHAR)) extended_price 
             ,COUNT(CAST((ss_ext_list_price) AS VARCHAR)) list_price
             ,COUNT(CAST((ss_ext_tax) AS VARCHAR)) extended_tax 
       from store_sales
           ,date_dim
           ,store
...
INSERT INTO tmp_i_6442 SELECT * FROM ( select  c_last_name
       ,c_first_name
       ,ca_city
       ,bought_city
       ,ss_ticket_number
