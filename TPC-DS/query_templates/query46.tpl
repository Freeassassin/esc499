...
-- 
 ...
 from
   (select ss_ticket_number
          ,ss_customer_sk
          ,ca_city bought_city
          ,sum(COALESCE(ss_coupon_amt, 0)) amt
          ,sum(COALESCE(ss_net_profit, 0)) profit
    from store_sales
     left outer join promotion on ss_promo_sk = p_promo_sk,date_dim,store,household_demographics,customer_address 
