...
CREATE TEMP TABLE tmp_u_5345 AS SELECT *, -1 as _dummy_update_col FROM ( select  i_item_id,
 ...
 WHERE (1=1 OR 'a' IS NOT NULL) AND COALESCE(NULL, 1)=1 AND  ss_sold_date_sk = d_date_sk and
...
UPDATE tmp_u_5345 SET _dummy_update_col = 1 WHERE 1=0;
SELECT 1 [_LIMITC];
